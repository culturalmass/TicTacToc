...
`;
export const createExpoTicketsObjets = /* GraphQL */ `
    mutation CreateExpoTicketsObjets(
        $input: CreateExpoTicketsObjetsInput!
        $condition: ModelExpoTicketsObjetsConditionInput
    ) {
        createExpoTicketsObjets(input: $input, condition: $condition) {
            id
            tickets
            createdAt
            updatedAt
...
`;
export const updateExpoTicketsObjets = /* GraphQL */ `
    mutation UpdateExpoTicketsObjets(
        $input: UpdateExpoTicketsObjetsInput!
        $condition: ModelExpoTicketsObjetsConditionInput
    ) {
        updateExpoTicketsObjets(input: $input, condition: $condition) {
            id
            tickets
            createdAt
            updatedAt
...
`;
export const deleteExpoTicketsObjets = /* GraphQL */ `
    mutation DeleteExpoTicketsObjets(
        $input: DeleteExpoTicketsObjetsInput!
        $condition: ModelExpoTicketsObjetsConditionInput
    ) {
        deleteExpoTicketsObjets(input: $input, condition: $condition) {
            id
            tickets
            createdAt
            updatedAt
